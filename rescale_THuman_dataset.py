...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input_dir', type=str, default='C:\Users\user\THuman2.0', help="Input data directory.")
    ...
    print("NOTE: Original .obj files will be overwritten by newly scaled .obj file.")
    ...
    print("num of .obj meshes found: ", num_paths)
